    ...
    def inner_decorator(func):
        ...
        def handler_wrapper(event, lambdaContext=None):
            ...
            if 'LambdaParentRequestId' in event:
                ...
                try:
                ...
                except (bclient.exceptions.EC2ThrottledException, bclient.exceptions.ENILimitReachedException,
                        bclient.exceptions.TooManyRequestsException,
                    ...
                    logger.error('You should make sure you have enough capacity and high enough limits to execute the' +
                                 ' chained function.')
                except (bclient.exceptions.EC2UnexpectedException, bclient.exceptions.InvalidParameterValueException,
                        bclient.exceptions.InvalidRequestContentException, bclient.exceptions.InvalidRuntimeException,
                        bclient.exceptions.InvalidSecurityGroupIDException, bclient.exceptions.InvalidSubnetIDException,
                        bclient.exceptions.InvalidZipFileException, bclient.exceptions.KMSInvalidStateException,
                        bclient.exceptions.KMSNotFoundException, bclient.exceptions.RequestTooLargeException,
                        bclient.exceptions.ResourceNotFoundException, bclient.exceptions.ServiceException,
            ...
            try:
                return_value = result.send(event, lambdaContext)
            except Exception as e:
...
def sdecorator(decoratorHandleDelete=False, expectedProperties=None, genUUID=True, enforceUseOfClass=False,
               hideResourceDeleteFailure=False, redactConfig=None, timeoutFunction=True):
    ...
    def standalone_decorator_inner(func):
        ...
        @decorator(enforceUseOfClass=enforceUseOfClass, hideResourceDeleteFailure=hideResourceDeleteFailure,
                   redactConfg=redactConfig, timeoutFunction=timeoutFunction)
